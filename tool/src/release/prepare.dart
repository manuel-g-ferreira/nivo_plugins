...
void _buildReleaseCatalog(String rootDir) {
  final publicRepo =
      Platform.environment['NIVO_PLUGINS_PUBLIC_REPO'] ?? defaultCatalogRepo;
  writePluginCatalogFromPlugins(
    pluginsRoot: p.join(rootDir, 'plugins'),
    publicRepo: publicRepo,
    outputPath: p.join(rootDir, 'catalog', 'catalog.json'),
  );
}
