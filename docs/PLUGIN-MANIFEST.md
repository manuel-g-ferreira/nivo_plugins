...
|-------|------|-------------|
| `identifier` | string | Unique slug, e.g. `librelink` (package folder: `librelink.nivoplugin`) |
...
On macOS the same folder may be named `Example CGM.nivoplugin` (directory bundle).
