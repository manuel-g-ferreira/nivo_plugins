...
- **API notes:** [librelink-api-analysis.md](../../docs/librelink-api-analysis.md)
...
Output: `plugins/LibreLink/dist/librelink.nivo`

## Install into Nivo

Drag **`dist/librelink.nivo`** into **Settings → Plugins**, or use **Choose plugin file…**.
