...
**Recommendation for Nivo LibreLink plugin:** Follow **DiaKEM `readRaw` + `read` split** internally; one graph HTTP call; expose standard host commands. Implemented in `plugins/LibreLink/`.
...
- `plugins/LibreLink/` — reference implementation
