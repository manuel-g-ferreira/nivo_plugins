...
Commands:
  ...
  build     Compile, sign (macOS), write dist/<id>.nivoplugin (--no-package to skip)
  package   Build dist/<id>.nivoplugin (after compile)

Install .nivoplugin files via the nivo app repo:
  dart run tool/install_plugin.dart path/to/plugin.nivoplugin
